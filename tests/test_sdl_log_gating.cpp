...
static const std::set<std::pair<std::string, int>> kAllowlist = {
    ...
    {"MidiMusic.cpp", 483},       // SDL_InitSubSystem(AUDIO) failed (once-per-process via backendInitFailed latch, TASK-24H-1109)
    {"MidiMusic.cpp", 493},       // SDL_OpenAudioDeviceStream failed (same latch)
    {"MidiMusic.cpp", 640},       // MCI_OPEN: failed to load MIDI file (failure)
