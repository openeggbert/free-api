...
| `joyGetPosEx`/`joyGetNumDevs` | WinMM/Joystick | Yes (optional) | No | STUB (acceptable — reports 0 devices; no evidence of real analog-input need) | none (safe by construction) |
